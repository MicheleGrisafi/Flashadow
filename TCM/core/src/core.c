...
__attribute__((section(".tcm:rodata"))) const uint16_t safe_calla   = 0xFC54;
__attribute__((section(".tcm:rodata"))) const uint16_t safe_ret     = 0xfd0C;
__attribute__((section(".tcm:rodata"))) const uint16_t safe_reti    = 0xfd66;
__attribute__((section(".tcm:rodata"))) const uint16_t safe_reta    = 0xfdae;

__attribute__((section(".tcm:rodata"))) const uint16_t safe_mov     = 0xfdd6;
__attribute__((section(".tcm:rodata"))) const uint16_t safe_movx    = 0xfdE8;
__attribute__((section(".tcm:rodata"))) const uint16_t safe_xor     = 0xfdfc;
__attribute__((section(".tcm:rodata"))) const uint16_t safe_xorx    = 0xfe0e;
__attribute__((section(".tcm:rodata"))) const uint16_t safe_add     = 0xfe22;
__attribute__((section(".tcm:rodata"))) const uint16_t safe_addx    = 0xfe34;
__attribute__((section(".tcm:rodata"))) const uint16_t safe_addc    = 0xfe48;
__attribute__((section(".tcm:rodata"))) const uint16_t safe_addcx   = 0xfe5a;
__attribute__((section(".tcm:rodata"))) const uint16_t safe_dadd    = 0xfe6e;
__attribute__((section(".tcm:rodata"))) const uint16_t safe_daddx   = 0xfe80;
__attribute__((section(".tcm:rodata"))) const uint16_t safe_sub     = 0xfe94;
__attribute__((section(".tcm:rodata"))) const uint16_t safe_subx    = 0xfea6;
__attribute__((section(".tcm:rodata"))) const uint16_t safe_subc    = 0xfeba;
__attribute__((section(".tcm:rodata"))) const uint16_t safe_subcx   = 0xfecc;

__attribute__((section(".tcm:rodata"))) const uint16_t receive_update_address = 0xfee4;
